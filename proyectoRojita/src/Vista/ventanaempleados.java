...
public class ventanaempleados extends JFrame {
	...
	public ventanaempleados() {
		...
		boton_anotaringreso.setFont(new Font("Century Gothic", Font.PLAIN, 14));
		...
		boton_anotarsalida.setFont(new Font("Century Gothic", Font.PLAIN, 14));
		...
		boton_nuevaventa.setFont(new Font("Century Gothic", Font.PLAIN, 14));
		...
		boton_mostrarinventario.setFont(new Font("Century Gothic", Font.PLAIN, 14));
		...
		boton_vercliente.setFont(new Font("Century Gothic", Font.PLAIN, 14));
		...
		boton_verboletas.setFont(new Font("Century Gothic", Font.PLAIN, 14));
